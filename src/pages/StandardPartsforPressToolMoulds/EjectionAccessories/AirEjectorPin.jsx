const AirEjectorPin = () => {
    return (
        <>
            <div id="catalogue18" className="footer_bg">
                ...
                <div className="container">
                    ...
                    <div className="product-block">
                        ...
                        <div className="row mt-2 g-1">
                            ...
                            <div className="col-5">
                                <img
                                    src="../images/AirEjectorPin61_second.webp"
                        ...
                        <div className="row stp_table_padd mt-3">
                            <div className="col-12">
                                <div className="table-container mb-0 divs_font_table cell_table_first-6">
                                    {/* <caption>VB2.3 Data (001-040)</caption> */}
                                    <div className="table-header">
                                        <div className="table-row">
                                            <span className="cell">Code</span>
                                            <span className="cell">d1</span>
                                            <span className="cell">d2 (approx.)</span>
                                    ...
                                    <div className="table-body">
                                        <div className="table-row">
                                            ...
                                            <span className="cell rowspan" data-rows={2}>24</span>
                                            <span className="cell rowspan" data-rows={2}>11</span>
                                        ...
                                        <div className="table-row">
                                            ...
                                            <span className="cell rowspan" data-rows={2}>26</span>
                    ...
                    {/* <div className="product-block">
                                ...
                                <div className="table-container mb-0 divs_font_table cell_table_first-5">
                                    ...
                                    <div className="table-body">
                                        ...
                                        <div className="table-row">
                                            ...
                                            <span className="cell">12</span>
                                            <span className="cell rowspan" data-rows={2}>35</span>
                                        ...
                                        <div className="table-row">
                                            ...
                                            <span className="cell">20</span>
                                            <span className="cell">14.9</span>
                                            <span className="cell rowspan" data-rows={2}>45</span>
                        ...
                        <b>Notes:</b>
                        <ul>
                            <li>These air ejector pins are used to eject plastic products without any hole on its wall.</li>
                            <li>Air pressure is uniformly released from the pin which helps the product to eject easily from the mould.</li>
